...
const DicoClash = () => {
  ...
  if (gameState === 'welcome') {
    return (
        ...
        <div className="bg-black/20 border-b border-white/10 backdrop-blur-sm py-2 text-center text-xs text-gray-300">
          Publicité - 728x90
        </div>
        ...
        <div className="max-w-6xl mx-auto p-4 md:p-8 space-y-8">
          <div className="text-center py-12 space-y-6">
            ...
            <h1 className="text-6xl md:text-8xl font-black text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-400 to-pink-500">
              DicoClash
            </h1>
            ...
            <div className="flex justify-center gap-8 md:gap-16 py-6">
              <div className="text-center">
                <div className="flex items-center justify-center gap-2 text-3xl md:text-4xl font-black text-green-400">
                  <Users className="w-8 h-8" strokeWidth={3} />
                  {onlinePlayers}
                </div>
                <p className="text-sm text-gray-200 font-bold mt-1">en ligne</p>
              </div>
              <div className="text-center">
                <div className="flex items-center justify-center gap-2 text-3xl md:text-4xl font-black text-blue-400">
            ...
            <Card className="max-w-md mx-auto border-2 border-cyan-400/30 shadow-2xl bg-white/10 backdrop-blur-md">
          ...
          {/* Reste du contenu identique à avant mais sans l'image de fond */}
          <Card className="border-2 border-blue-400/30 bg-white/10 backdrop-blur-md shadow-xl">
            ...
            <CardContent className="p-6">
              ...
              <div className="mt-6 p-4 bg-cyan-500/20 rounded-xl border-2 border-cyan-400/30">
          ...
          <Card className="border-2 border-yellow-400/30 bg-white/10 backdrop-blur-md shadow-xl">
            <CardHeader className="bg-white/5 border-b border-white/10">
              <CardTitle className="text-2xl font-black flex items-center gap-2 text-white">
        ...
        <div className="max-w-4xl mx-auto p-4 md:p-8 space-y-6">
          <div className="text-center">
            ...
            <div className="flex justify-center gap-4 flex-wrap">
              ...
              {myRank > 0 && (
                <Badge className="text-lg px-6 py-2 border-2 bg-white/10 backdrop-blur-md text-white border-pink-400/30 shadow-lg">
          ...
          <Card className="border-2 border-cyan-400/30 shadow-2xl bg-white/10 backdrop-blur-md">
            <CardContent className="p-8 text-center space-y-6">
              ...
              <div className="flex justify-center gap-12 mt-6">
                <div className="text-center">
                  <div className="text-green-400 text-3xl font-black">{onlinePlayers}</div>
                  <p className="text-xs text-gray-300 font-bold">En ligne</p>
                </div>
                <div className="text-center">
                  <div className="text-blue-400 text-3xl font-black">{activeGames}</div>
          ...
          <div className="grid grid-cols-3 gap-4">
            <Card className="bg-white/10 backdrop-blur-md border-2 border-yellow-400/30 shadow">
            ...
            <Card className="bg-white/10 backdrop-blur-md border-2 border-green-400/30 shadow">
              <CardContent className="p-6 text-center">
                <Star className="w-12 h-12 mx-auto mb-3 text-green-400" strokeWidth={2.5} />
                <p className="text-4xl font-black text-white">{gamesWon}</p>
                <p className="text-sm text-gray-200 font-bold mt-1">Parfaites</p>
              </CardContent>
            </Card>
            <Card className="bg-white/10 backdrop-blur-md border-2 border-cyan-400/30 shadow">
              <CardContent className="p-6 text-center">
          ...
          <div className="text-center">
            <Button variant="outline" className="border-2 border-white/20 bg-white/10 backdrop-blur-md text-white hover:bg-white/20" onClick={() => {
  ...
  if (gameState === 'queue') {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-purple-900 flex items-center justify-center p-4">
        <Card className="w-full max-w-md border-2 border-cyan-400/30 shadow-2xl bg-white/10 backdrop-blur-md">
          <CardContent className="p-10 text-center space-y-6">
            ...
            <div>
              <h2 className="text-3xl font-black text-white mb-2">Recherche...</h2>
            ...
            <Button variant="outline" className="border-2 border-white/20 bg-white/10 text-white w-full py-6" onClick={() => {
  ...
  if (gameState === 'playing') {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-purple-900 p-2 md:p-4">
        <div className="max-w-5xl mx-auto space-y-3">
          ...
          {isGiver && (
            <Card className="border-2 border-cyan-400/30 bg-white/10 backdrop-blur-md shadow-lg">
          ...
          <div className="grid md:grid-cols-2 gap-3">
            <Card className="border-2 border-blue-400/30 bg-white/10 backdrop-blur-md shadow-lg">
            ...
            <Card className="border-2 border-indigo-400/30 bg-white/10 backdrop-blur-md shadow-lg">
              <CardHeader className="pb-3 bg-white/5 border-b border-white/10">
                <CardTitle className="text-base font-black flex items-center gap-2 text-white">
          ...
          {waitingForPartner && (
            <div className="text-center py-8 bg-white/10 rounded-xl border-2 border-white/10 shadow backdrop-blur-md">
  ...
  if (gameState === 'results') {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-purple-900 flex items-center justify-center p-4">
        <Card className="w-full max-w-2xl border-2 border-cyan-400/30 shadow-2xl bg-white/10 backdrop-blur-md">
